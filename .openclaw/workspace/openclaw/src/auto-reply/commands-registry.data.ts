...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "predictions",
      nativeName: "predictions",
      description: "Check predictive engine status, patterns, and predictions.",
      textAliases: ["/predictions", "/predictive"],
      args: [
        {
          key: "subcommand",
          description: "Subcommand: status, check, patterns, history, stats, enable, disable, help",
          required: false,
        },
        {
          key: "arg",
          description: "Additional argument (e.g., limit for patterns/history)",
          required: false,
        },
      ],
      category: "status",
