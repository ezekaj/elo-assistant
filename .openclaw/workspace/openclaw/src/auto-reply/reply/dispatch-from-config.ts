...
export async function dispatchReplyFromConfig(params: {
  ...
  // Skip if urgency too low (unless mentioned/reply/direct - those always respond)
  // Direct messages (TUI, webchat) should ALWAYS respond regardless of urgency
  if (adaptiveSuggestion.shouldRespond === false && !isMentioned && !isReply && isGroup) {
