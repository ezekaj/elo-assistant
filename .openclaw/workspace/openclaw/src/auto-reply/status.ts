...
import { calculateAutoCompactThreshold } from "../agents/compaction-thresholds.js";
...
export function buildStatusMessage(args: StatusArgs): string {
  ...
  let contextTokens =
    ...
    calculateAutoCompactThreshold(model) ??
  ...
  if (args.includeTranscriptUsage) {
    ...
    if (logUsage) {
      ...
      if (!contextTokens && logUsage.model) {
        contextTokens = calculateAutoCompactThreshold(logUsage.model) ?? contextTokens;
      }
