...
import { registerHeartbeatV2Commands } from "../../infra/heartbeat-v2/cli.js";
import { defaultRuntime } from "../../runtime.js";
import { getFlagValue, getPositiveIntFlagValue, getVerboseFlag, hasFlag } from "../argv.js";
import { registerBrowserCli } from "../browser-cli.js";
import { registerConfigCli } from "../config-cli.js";
import { registerMemoryCli, runMemoryStatus } from "../memory-cli.js";
import { registerPredictiveCLI } from "../predictive-cli.js";
...
export const commandRegistry: CommandRegistration[] = [
  ...
  {
    id: "heartbeat-v2",
    register: ({ program }) => registerHeartbeatV2Commands(program),
  },
  {
    id: "predictive",
    register: ({ program }) => registerPredictiveCLI(program),
  },
];
