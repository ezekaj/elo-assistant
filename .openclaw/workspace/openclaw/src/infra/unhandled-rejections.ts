...
export function installUnhandledRejectionHandler(): void {
  process.on("unhandledRejection", (reason, _promise) => {
    ...
    // Default: log the error but don't crash
    // Unhandled rejections are often recoverable errors in async operations
    console.error(
      "[openclaw] Unhandled promise rejection (graceful - service continues):",
      formatUncaughtError(reason),
    );
    // Don't exit - let the service continue operating
