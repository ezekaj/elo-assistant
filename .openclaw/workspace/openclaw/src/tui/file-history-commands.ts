...
/**
 * Extended SlashCommand with handler support
 */
interface OpenClawSlashCommand extends SlashCommand {
 ...
 */
export function createCheckpointCommand(): OpenClawSlashCommand {
  return {
    name: "checkpoint",
 ...
 */
export function createRewindCommand(): OpenClawSlashCommand {
  return {
    name: "rewind",
 ...
 */
export function createFileHistoryStatusCommand(): OpenClawSlashCommand {
  return {
    name: "file-history",
